...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_lim = QtWidgets.QCheckBox(self.tab)
        self.checkBox_lim.setObjectName("checkBox_lim")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.checkBox_lim)
        self.label_13 = QtWidgets.QLabel(self.tab)
        self.label_13.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_13.setObjectName("label_13")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_13)
        self.lineEdit_ymax_2 = QtWidgets.QLineEdit(self.tab)
        self.lineEdit_ymax_2.setObjectName("lineEdit_ymax_2")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ymax_2)
        self.label_16 = QtWidgets.QLabel(self.tab)
        self.label_16.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_16.setObjectName("label_16")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_16)
        self.lineEdit_ymin_2 = QtWidgets.QLineEdit(self.tab)
        self.lineEdit_ymin_2.setObjectName("lineEdit_ymin_2")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ymin_2)
        self.verticalLayout_2.addLayout(self.formLayout_3)
        self.checkBox_max_line = QtWidgets.QCheckBox(self.tab)
        self.checkBox_max_line.setObjectName("checkBox_max_line")
        self.verticalLayout_2.addWidget(self.checkBox_max_line)
        ...
        self.lineEdit_anchor_x = QtWidgets.QLineEdit(self.groupBox_5)
        self.lineEdit_anchor_x.setEnabled(False)
        self.lineEdit_anchor_x.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lineEdit_anchor_x.setObjectName("lineEdit_anchor_x")
        self.gridLayout.addWidget(self.lineEdit_anchor_x, 4, 2, 1, 1)
        ...
        self.lineEdit_anchor_y = QtWidgets.QLineEdit(self.groupBox_5)
        self.lineEdit_anchor_y.setEnabled(False)
        self.lineEdit_anchor_y.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.lineEdit_anchor_y.setObjectName("lineEdit_anchor_y")
        self.gridLayout.addWidget(self.lineEdit_anchor_y, 5, 2, 1, 1)
        ...
        self.checkBox_anchor = QtWidgets.QCheckBox(self.groupBox_5)
        self.checkBox_anchor.setObjectName("checkBox_anchor")
        self.gridLayout.addWidget(self.checkBox_anchor, 4, 0, 1, 1)
        self.checkBox_nomalize_phase = QtWidgets.QCheckBox(self.groupBox_5)
        self.checkBox_nomalize_phase.setObjectName("checkBox_nomalize_phase")
        self.gridLayout.addWidget(self.checkBox_nomalize_phase, 6, 0, 1, 1)
        ...
        self.pushButton_openPortData = QtWidgets.QPushButton(self.tab_3)
        ...
        self.lineEdit_ncell = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_ncell.setObjectName("lineEdit_ncell")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ncell)
        self.label_10 = QtWidgets.QLabel(self.tab_3)
        self.label_10.setObjectName("label_10")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_10)
        self.lineEdit_cell_len = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_cell_len.setEnabled(False)
        self.lineEdit_cell_len.setObjectName("lineEdit_cell_len")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_cell_len)
        self.label_9 = QtWidgets.QLabel(self.tab_3)
        self.label_9.setObjectName("label_9")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_9)
        self.lineEdit_m1 = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_m1.setObjectName("lineEdit_m1")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineEdit_m1)
        self.checkBox_xlim = QtWidgets.QCheckBox(self.tab_3)
        self.checkBox_xlim.setObjectName("checkBox_xlim")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.checkBox_xlim)
        self.checkBox_ylim = QtWidgets.QCheckBox(self.tab_3)
        self.checkBox_ylim.setObjectName("checkBox_ylim")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.LabelRole, self.checkBox_ylim)
        self.label_14 = QtWidgets.QLabel(self.tab_3)
        self.label_14.setObjectName("label_14")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.label_14)
        self.lineEdit_ymax = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_ymax.setObjectName("lineEdit_ymax")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ymax)
        self.label_15 = QtWidgets.QLabel(self.tab_3)
        self.label_15.setObjectName("label_15")
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.LabelRole, self.label_15)
        self.lineEdit_ymin = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_ymin.setObjectName("lineEdit_ymin")
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.lineEdit_ymin)
        self.label_11 = QtWidgets.QLabel(self.tab_3)
        self.label_11.setObjectName("label_11")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.label_11)
        self.lineEdit_xmax = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_xmax.setObjectName("lineEdit_xmax")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.lineEdit_xmax)
        self.label_12 = QtWidgets.QLabel(self.tab_3)
        self.label_12.setObjectName("label_12")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.label_12)
        self.lineEdit_xmin = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_xmin.setObjectName("lineEdit_xmin")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.lineEdit_xmin)
        self.lineEdit_m2 = QtWidgets.QLineEdit(self.tab_3)
        self.lineEdit_m2.setObjectName("lineEdit_m2")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineEdit_m2)
        ...
        self.actionOpen_in_Browser = QtWidgets.QAction(MainWindow)
        ...
        self.menuHelp.addAction(self.actionOpen_in_Browser)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_lim.setText(_translate("MainWindow", "limit"))
        self.label_13.setText(_translate("MainWindow", "y max"))
        self.lineEdit_ymax_2.setText(_translate("MainWindow", "5"))
        self.label_16.setText(_translate("MainWindow", "y min"))
        self.lineEdit_ymin_2.setText(_translate("MainWindow", "-10"))
        self.checkBox_max_line.setText(_translate("MainWindow", "max line"))
        ...
        self.lineEdit_anchor_x.setText(_translate("MainWindow", "0"))
        self.lineEdit_phase_min.setText(_translate("MainWindow", "-180"))
        self.lineEdit_anchor_y.setText(_translate("MainWindow", "0"))
        self.label_7.setText(_translate("MainWindow", "Min"))
        self.checkBox_anchor.setText(_translate("MainWindow", "zero anchor"))
        self.checkBox_nomalize_phase.setText(_translate("MainWindow", "nomalize as phase"))
        self.label_19.setText(_translate("MainWindow", "( -180 to 180 )"))
        ...
        self.pushButton_openPortData.setText(_translate("MainWindow", "Open Port Data"))
        self.label_portData.setText(_translate("MainWindow", "<touch stone data>"))
        self.label_8.setText(_translate("MainWindow", "cell number"))
        self.lineEdit_ncell.setText(_translate("MainWindow", "8"))
        self.label_10.setText(_translate("MainWindow", "cell length [mm]"))
        self.lineEdit_cell_len.setText(_translate("MainWindow", "6.6"))
        self.label_9.setText(_translate("MainWindow", "phase offset : m (2 pi m)"))
        self.lineEdit_m1.setText(_translate("MainWindow", "0"))
        self.checkBox_xlim.setText(_translate("MainWindow", "x limit"))
        self.checkBox_ylim.setText(_translate("MainWindow", "y limit"))
        self.label_14.setText(_translate("MainWindow", "        y max"))
        self.lineEdit_ymax.setText(_translate("MainWindow", "3.5"))
        self.label_15.setText(_translate("MainWindow", "        y min"))
        self.lineEdit_ymin.setText(_translate("MainWindow", "0.5"))
        self.label_11.setText(_translate("MainWindow", "        x max"))
        self.lineEdit_xmax.setText(_translate("MainWindow", "0.3"))
        self.label_12.setText(_translate("MainWindow", "        x min"))
        self.lineEdit_xmin.setText(_translate("MainWindow", "-0.3"))
        self.lineEdit_m2.setText(_translate("MainWindow", "0"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "dispersion"))
        ...
        self.actionOpen_in_Browser.setText(_translate("MainWindow", "Open in Browser"))
